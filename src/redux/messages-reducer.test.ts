import messagesReducer, {MessagesPageType, sendMessageAC, updateNewMessageBodyAC} from "./messages-reducer";

test('new messages should be assigned a newMessageBody', () => {
    ...
    const action = updateNewMessageBodyAC('Hello');
